const faturamentoDiario = [
  ...
  function analisarFaturamento(dados) {
    ...
    const mediaFaturamento = diasComFaturamento.reduce((soma, dia) => soma + dia.valor, 0) / diasComFaturamento.length
  ...
  console.log("Menor faturamento diário:", resultado.menorFaturamento)
  console.log("Maior faturamento diário:", resultado.maiorFaturamento)
  console.log("Número de dias acima da média de faturamento:", resultado.diasAcimaDaMedia)
